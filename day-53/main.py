...
form_link = "https://docs.google.com/forms/d/e/1FAIpQLSedMVp2f8dZV95mnJEcqXRHHv1KAjGj4YB8iBh8vLgJdjhkOQ/viewform?usp=sf_link"
...
PRICES_XPATH = '//*[@id="mG61Hd"]/div[2]/div/div[2]/div[2]/div/div/div[2]/div/div[1]/div/div[1]/input'
LINKS_XPATH = '//*[@id="mG61Hd"]/div[2]/div/div[2]/div[3]/div/div/div[2]/div/div[1]/div/div[1]/input'
SUBMIT_XPATH = '//*[@id="mG61Hd"]/div[2]/div/div[3]/div[1]/div/div'
...
class Research:
    ...
    def fill_form(self):
        for n in range(len(self.address_list)):
            ...
            time.sleep(3)
            try:                
                self.driver.find_element(By.XPATH, value = ADDRESS_XPATH).send_keys(self.address_list[n])
                self.driver.find_element(By.XPATH, value = PRICES_XPATH).send_keys(self.price_list[n])
                self.driver.find_element(By.XPATH, value = LINKS_XPATH).send_keys(self.links_list[n])
                self.driver.find_element(By.XPATH, value = SUBMIT_XPATH).click()
            except Exception:
                pass
            time.sleep(2)
